...
<div class="container">
  <div class="con_content">
    <div class="about_box">
      <h2 class="nh1"><span>您现在的位置是：<a href="/" target="_blank">网站首页</a>>><a href="#" target="_blank">学习笔记</a></span><b>学习笔记</b></h2>
      
      <div class="dtxw box">
            <?php if(!empty($resNote)): ?>
              <?php foreach($resNote as $key =>$val) :?>
           <li>
    ...
    <form action="index.php?m=note&a=save" method="post" enctype="multipart/form-data">

     <div class="biaoti"> 
          <b>标题</b><input type="text"  placeholder="输入笔记的标题" name="title" />
     </div>
      <br />
      <?php if(!empty($resNote)): ?>  
      <input type="hidden" name="id"  value="<?=$resNote[0]['id'];?>" >
      <?php endif;?>
      <textarea name="info" class="ckeditor" id="TextAreal"  ></textarea>
      <br/>
        <input  class="save" type="submit" name="newnote" value="新建笔记">
       <input  class="save" type="submit" name="addnote" value="追加笔记">
