...
<div class="container">
  <div class="con_content">
    ...
    <form action="index.php?m=diary&a=save" method="post" enctype="multipart/form-data">

     <div class="biaoti"> 
          <b>日记标题</b><input type="text"  placeholder="输入日记的标题" name="title" />
     </div>
      <br />
      <textarea name="info" class="ckeditor" id="TextAreal"  ></textarea>
      <br/>
      <input  class="save" type="submit" value="发表">
