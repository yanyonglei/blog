...
<div class="container">
  <div class="con_content">
    <div class="about_box">
      <h2 class="nh1"><span>您现在的位置是：<a href="/" target="_blank">网站首页</a>>><a href="#" target="_blank">留言版</a></span><b>留言版</b></h2>
      <div class="dtxw box">
            <?php if(!empty($resDiary)): ?>
              <?php foreach($resDiary as $key =>$val) :?>
           <li>
    ...
    <form action="index.php?m=liuyan&a=save" method="post" enctype="multipart/form-data">
      <br />
      <textarea name="info" class="ckeditor" id="TextAreal"  ></textarea>
      <br/>
      <input  class="save" type="submit" value="留言">
